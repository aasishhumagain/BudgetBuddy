...
template <> constexpr inline auto signup::qt_create_metaobjectdata<qt_meta_tag_ZN6signupE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "signup",
        "on_buttonCreateAccount_clicked",
        "",
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'on_buttonCreateAccount_clicked'
...
void signup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_buttonCreateAccount_clicked(); break;
        case 1: _t->on_checkBoxShowPassword_toggled((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        default: ;
        }
    }
}
