...
template <> constexpr inline auto login::qt_create_metaobjectdata<qt_meta_tag_ZN5loginE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "",
        "on_buttonSignup_clicked",
        "on_buttonForgotPassword_clicked",
        "on_checkBoxPassword_toggled",
        "checked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_buttonLogin_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_buttonSignup_clicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_buttonForgotPassword_clicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_checkBoxPassword_toggled'
...
void login::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_buttonSignup_clicked(); break;
        case 2: _t->on_buttonForgotPassword_clicked(); break;
        case 3: _t->on_checkBoxPassword_toggled((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        default: ;
        }
    }
}
