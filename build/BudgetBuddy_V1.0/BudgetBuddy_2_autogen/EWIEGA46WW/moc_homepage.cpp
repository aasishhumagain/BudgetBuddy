...
template <> constexpr inline auto homepage::qt_create_metaobjectdata<qt_meta_tag_ZN8homepageE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "homepage",
        "on_buttonAddTransaction_clicked",
        "",
        "on_buttonViewTransaction_clicked",
        "on_buttonSetGoal_clicked",
        "on_buttonAnalyzeReport_clicked",
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'on_buttonAddTransaction_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_buttonViewTransaction_clicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_buttonSetGoal_clicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_buttonAnalyzeReport_clicked'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_buttonProfile_clicked'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'handleLogout'
        QtMocHelpers::SlotData<void()>(7, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_buttonLogout_clicked'
...
void homepage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_buttonAddTransaction_clicked(); break;
        case 1: _t->on_buttonViewTransaction_clicked(); break;
        case 2: _t->on_buttonSetGoal_clicked(); break;
        case 3: _t->on_buttonAnalyzeReport_clicked(); break;
        case 4: _t->on_buttonProfile_clicked(); break;
        case 5: _t->handleLogout(); break;
        case 6: _t->on_buttonLogout_clicked(); break;
        default: ;
        }
    }
    (void)_a;
